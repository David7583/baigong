# ============================================================
# File: build_unit_cooccurrence_graph_v0003.py
# 中文名: 对象级共现关系图构建脚本
# Version: v0003
#
# Layer: execution
...
# ALIAS_META
# ============================================================
# alias: build_unit_cooccurrence_graph_v0003
# family: build_unit_cooccurrence_graph
# role: object_graph_builder_cooccurrence
# version: v0003
# status: active
# entry_point: scripts/action/pipelines/build_unit_cooccurrence_graph_v0003.py
# input:
...
SCRIPT_NAME = "build_unit_cooccurrence_graph_v0003"
...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Build object-level cooccurrence graph from register + cooccurrence facts (v0003)."
    )
    ...
    p.add_argument("--output-root", default="actioning/pipelines/build_unit_cooccurrence_graph_action", help="Output root directory.")
