...
# ALIAS_META
# ============================================================
# alias: validate_ingest_payload
# family: validate_ingest_payload
# role: payload_validator
# version: v0001
# status: active
# entry_point: scripts/action/anchor/validate_ingest_payload_v0001.py
# input:
#   - concept_identity_declarations (jsonl)
#   - instance_identity_declarations (jsonl)
#   - attribute_declarations (jsonl)
#   - run_meta (json, optional, for run_id resolution)
# output:
#   - validation_report (json)
# depends_on:
#   - ingest_concept_units_v0001
#   - ingest_instance_units_v0001
#   - ingest_attribute_units_v0001
# used_by:
#   - sql_writer_v0001
# ============================================================
