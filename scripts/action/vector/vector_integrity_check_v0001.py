...
# version: v0001
# status: active
# entry_point: scripts/action/vector/vector_integrity_check_v0001.py
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--sql-db", default="sql/action_data.db", help="Path to SQL database.")
    ap.add_argument("--chromadb-path", default="chromadb/action/action_data/vectors", help="Path to ChromaDB persistence.")
