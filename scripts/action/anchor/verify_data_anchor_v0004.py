# ============================================================
# 文件名: verify_data_anchor_v0004.py
# 中文名: 完整坐标数据层锚点存在性校验脚本
# 版本号: v0004
#
# 主层级: action
# 层级: persistence / preflight
...
# version: v0004
# status: active
# entry_point: scripts/action/anchor/verify_data_anchor_v0004.py
# input:
...
SCRIPT_NAME = "verify_data_anchor_v0004.py"
SCRIPT_VERSION = "v0004"
SCRIPT_FAMILY = "verify_data_anchor"
...
def _build_exists_sql(
    ...
    生成存在性查询 SQL。
    说明:
    - 使用 SQLite IS 保持 NULL 安全比较，并允许完整坐标索引查找。
    """
    return (
