...
# -*- coding: utf-8 -*-
# ============================================================
# File: vector_embedding_pipeline_v0003.py
...
# 4. 测试模式把全部可写路径限制在temp；真实模型还需独立显式确认。
...
# version: v0003
# status: active
# entry_point: scripts/orchestration/action/vector_embedding_pipeline_v0003.py
# input:
...
SCRIPT_NAME = "vector_embedding_pipeline_v0003.py"
...
PINNED_SCRIPTS = {
    ...
    "integrity": VECTOR_DIR / "vector_integrity_check_v0002.py",
}
